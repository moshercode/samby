...
class UpdateMemberApplicationVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  UpdateMemberApplicationVariablesBuilder guardianName(String? t) {
  ...
  UpdateMemberApplicationVariablesBuilder(this._dataConnect, {required  this.id,required  this.name,required  this.birthDate,required  this.idDoc,required  this.idDocImageUrl,required  this.signatureUrl,required  this.conditionsAcceptedAt,required  this.requestedAt,});
  Deserializer<UpdateMemberApplicationData> dataDeserializer = (dynamic json)  => UpdateMemberApplicationData.fromJson(jsonDecode(json));
  Serializer<UpdateMemberApplicationVariables> varsSerializer = (UpdateMemberApplicationVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateMemberApplicationData, UpdateMemberApplicationVariables>> execute() {
    return ref().execute();
  }

  MutationRef<UpdateMemberApplicationData, UpdateMemberApplicationVariables> ref() {
    UpdateMemberApplicationVariables vars= UpdateMemberApplicationVariables(id: id,name: name,birthDate: birthDate,idDoc: idDoc,idDocImageUrl: idDocImageUrl,guardianName: _guardianName,guardianIdDoc: _guardianIdDoc,guardianIdDocImageUrl: _guardianIdDocImageUrl,signatureUrl: signatureUrl,conditionsAcceptedAt: conditionsAcceptedAt,minorConditionsAcceptedAt: _minorConditionsAcceptedAt,requestedAt: requestedAt,);
    return _dataConnect.mutation("UpdateMemberApplication", dataDeserializer, varsSerializer, vars);
  }
}

@immutable
class UpdateMemberApplicationMemberUpdate {
  final String id;
  UpdateMemberApplicationMemberUpdate.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final UpdateMemberApplicationMemberUpdate otherTyped = other as UpdateMemberApplicationMemberUpdate;
  ...
  UpdateMemberApplicationMemberUpdate({
    required this.id,
  });
}

@immutable
class UpdateMemberApplicationData {
  final UpdateMemberApplicationMemberUpdate? member_update;
  UpdateMemberApplicationData.fromJson(dynamic json):
  
  member_update = json['member_update'] == null ? null : UpdateMemberApplicationMemberUpdate.fromJson(json['member_update']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    final UpdateMemberApplicationData otherTyped = other as UpdateMemberApplicationData;
...
@immutable
class UpdateMemberApplicationVariables {
  final String id;
  final String name;
  ...
  UpdateMemberApplicationVariables.fromJson(Map<String, dynamic> json):
  ...
  bool operator ==(Object other) {
    ...
    final UpdateMemberApplicationVariables otherTyped = other as UpdateMemberApplicationVariables;
    return id == otherTyped.id && 
  ...
  UpdateMemberApplicationVariables({
    required this.id,
    required this.name,

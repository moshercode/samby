        ...
        actions: viewModel.isManager
            ? <Widget>[
                IconButton(
                  ...
                  onPressed: () => NavigationUtils.showCreateEventAppointmentView(
                    viewModel,
                    event.id,
                  ),
                ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (!viewModel.hasFullAccess)
                  _AccessControlBanner(viewModel: viewModel, l: l)
                else
                  _AppointmentsSection(viewModel: viewModel, l: l),
  ...
  Widget build(BuildContext context) {
    ...
    if (viewModel.isAccessRejected) {
      return _buildBanner(
        ...
        message: l.eventDetailAccessRejected,
      );
    }
    final String conditionText =
        viewModel.event?.entryCondition?.isNotEmpty == true
            ? viewModel.event!.entryCondition!
            : l.eventDetailRequestAccess;
    return Column(
      ...
      children: <Widget>[
        ...
        Button(
          title: l.eventDetailRequestAccess,
          loading: viewModel.isLoading(),
          onTap: viewModel.requestAccess,
        ),
      ],
    );
  }
  ...
  Widget _buildBanner(
    ...
    return Row(
      children: <Widget>[
        ...
        Expanded(
          child: Text(
            message.isNotEmpty ? message : l.eventDetailFreeEntry,
